...
static art_leaf *make_leaf(const unsigned char *key, int key_len, const void *value) {
...
static void *recursive_insert(art_node *n, art_node **ref, const unsigned char *key, int key_len, const void *value, int depth, int *old) {
 ...
 */
void *art_insert(art_tree *t, const unsigned char *key, int key_len, const void *value) {
	int old_val = 0;
